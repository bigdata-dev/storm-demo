...
public class TridentTopologyMeger {
	...
	public static void main(String[] args) {
		...
		Stream newStream = tridentTopology.newStream("aaa", spout);
		
		FixedBatchSpout spout1 = new FixedBatchSpout(new Fields("sentence"), 1, new Values(1), new Values(2), new Values(3));
		Stream newStream2 = tridentTopology.newStream("bbb", spout1);
		
		tridentTopology.merge(newStream,newStream2)
