...
public class WorkerStormTopology {
	...
	public static void main(String [] args){
		...
		topologyBuilder.setBolt("bb", new NumBlot()).shuffleGrouping("aa");
	...
	/*	LocalCluster localCluster = new LocalCluster();
		...
		try {
			StormSubmitter.submitTopology(WorkerStormTopology.class.getSimpleName(), new Config(), topologyBuilder.createTopology());
