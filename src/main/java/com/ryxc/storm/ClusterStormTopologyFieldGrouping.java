...
public class ClusterStormTopologyFieldGrouping {
	...
	public static void main(String [] args){
		...
		topologyBuilder.setBolt("bb", new NumBlot(),3).fieldsGrouping("aa", new Fields("flag"));
		...
		try {
			...
			StormSubmitter.submitTopology(ClusterStormTopologyFieldGrouping.class.getSimpleName(), config, topologyBuilder.createTopology());
