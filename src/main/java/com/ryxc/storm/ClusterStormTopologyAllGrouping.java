...
public class ClusterStormTopologyAllGrouping {
	...
	public static void main(String [] args){
		...
		topologyBuilder.setBolt("bb", new NumBlot(),3).allGrouping("aa");
		...
		try {
			...
			StormSubmitter.submitTopology(ClusterStormTopologyAllGrouping.class.getSimpleName(), config, topologyBuilder.createTopology());
